...
const ProfileForm = () => {
  ...
  console.log("profile in profile from", profile);
    ...
    <>
      ...
      <form
        ...
        onSubmit={(event) =>
          handleProfile(
            event,
            profile.user.profile.length > 0 ? profile.user.profile[0]._id : ""
          )
        }
      >
        {showAlert()}
          ...
          <div className="profile-form__info">
            ...
            <div class="mb-3">
              ...
              <input
                type="text"
                id="status"
                placeholder="e.g:student,job,freelancher"
                class="form-control"
              />
            </div>
            <div class="mb-3">
          ...
          <div className="profile-form__img">
            <div className="profile-form__imgconatiner">
              ...
              <button type="button">
                Edit
                <input
                  onChange={(event) => handleImgFile(event)}
                  className="file-btn"
                  type="file"
                />
              </button>
